...
import myImg from "../../Assets/eliab.jpeg";
        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              that joy comes from creating solutions, I think… 🤷‍♂️
              <br />
              ...
              &nbsp; like
              <i>
                <b className="purple"> React.js, NODE JS and TYPESCRIPT</b>
              </i>
            </p>
          </Col>
        ...
        <Row>
          <Col md={12} className="home-about-social">
            ...
            <ul className="home-about-social-links">
              ...
              <li className="social-icons">
                <a
                  href="https://twitter.com/Ishimweeliab1"
                  target="_blank"
                  rel="noreferrer"
                  className="icon-colour  home-social-icons"
                >
